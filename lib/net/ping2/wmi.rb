...
module Net
  module Ping2
    ...
    # The Net::Ping2::WMI class encapsulates the Win32_PingStatus WMI class for
    # MS Windows.
    #
    class WMI < Base
      ...
      #  Net::Ping2::WMI.ping('www.perl.com')
      #
      #  # Ping with options
      #  Net::Ping2::WMI.ping('www.perl.com', :BufferSize => 64, :NoFragmentation => true)
      #--
      ...
      # Unlike Net::Ping2::WMI#ping, this method returns true or false to
